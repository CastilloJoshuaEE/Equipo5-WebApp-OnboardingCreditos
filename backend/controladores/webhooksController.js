...
class WebhooksController {
   ...
   */
  static async handleDiditWebhook(req, res) {
    try {
      ...
      if (status === 'Approved' && decision?.id_verification) {
        await WebhooksController.actualizarDocumentosVerificados(verificacion.solicitud_id, decision.id_verification);
      }
   ...
   * @param {Object} idVerification 
   */
  static async actualizarDocumentosVerificados(solicitudId, idVerification) {
    try {
