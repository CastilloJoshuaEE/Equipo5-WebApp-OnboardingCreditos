// backend/infrastructure/services/email/emailValidarServicio.js
...
class emailValidarServicio {
  constructor() {
    ...
    this.validateEmailBeforeAuth = this.validateEmailBeforeAuth.bind(this);
    this.verifyEmailOnly = this.verifyEmailOnly.bind(this);
  }
...
const fullValidation = await this.validateEmail(email);
